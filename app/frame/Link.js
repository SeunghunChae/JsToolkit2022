...
Link.symbolNameToLinkNameUnsorted = function(symbol) {
	var linker = "",
		ns = "";
	...
	return Link.hashPrefix+linker+ns+symbol.name+"Unsorted";
}
...
Link.prototype._makeSrcLink = function(srcFilePath) {
	...
	if(this.nametag!="") 
		var outFilePath = Link.base + publish.conf.srcDir + srcFile +publish.conf.ext+"#"+this.nametag;
	else 
